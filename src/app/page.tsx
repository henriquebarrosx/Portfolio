...
const Portfolio: FC = () => {
  ...
  const experiences = [
    ...
    },
    {
      cargo: "Desenvolvedor Frontend Sênior",
      empresa:
        "Assurance Consultoria em Tecnologia da Informacao LTDA · São Paulo, SP",
    ...
    <div className="font-sans">
      ...
      >
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row gap-12 items-center md:items-start">
          <motion.div
            className="relative w-52 h-52 flex justify-center md:justify-start"
            variants={item}
          >
            <Image
              src="/foto_perfil.jpg"
          ...
          <motion.div
            className="col-span-10 flex flex-col gap-4 text-base text-white/80 leading-relaxed max-w-3xl"
            variants={item}
          >
            <h2 className="text-2xl font-bold mb-3">Sobre</h2>

            <p>
              Desenvolvedor Full Stack Sênior com mais de 6 anos construindo
              aplicações web em domínios como sistemas bancários, telemedicina
              veterinária e logística ferroviária. Especialista em Angular (v14,
              v16 e v18) e React (v17 e v18) no frontend, com background sólido
              em Java (Spring Boot) e Node.js no backend, cobrindo o ciclo
              completo de desenvolvimento: arquitetura de componentes, testes
              automatizados (Jest, Testing Library, Karma, Jasmine, JUnit,
              Mockito), pipelines CI/CD (Jenkins, GitHub Actions) e qualidade de
              código (SonarQube, Checkmarx).
            </p>
          </motion.div>
        </div>
      </motion.section>
      ...
      <section className="relative bg-neutral-900 px-4 pb-6 pt-12 sm:px-8 sm:pt-14 sm:pb-8">
        ...
        <div className="flex flex-col items-center gap-y-4 py-20">
          ...
          <span className="text-sm text-neutral-700">Henrique Barros</span>
        </div>
      </section>
    </div>
  );
